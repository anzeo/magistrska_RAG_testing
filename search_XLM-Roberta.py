...
EMBEDDINGS_FILE = 'embeddings/XLM-ROBERTA/embeddings.npy'
...
def preprocess(text):
    # # Split text into chunks and encode each chunk
    # chunks = chunk_text(text)
    # chunk_embeddings = model.encode(chunks)
    # # Average the embeddings across all chunks to get a single representation for the text
